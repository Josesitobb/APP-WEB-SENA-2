...
CREATE TABLE IF NOT EXISTS `sgcitas`.`estilistas` (
  ...
  INDEX `Fk_2Id_Usuarios` (`Id_Usuarios` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `sgcitas`.`citas` (
  ...
  INDEX `FK1_Id_Clientes` (`Id_Clientes` ASC) VISIBLE,
  INDEX `FK2_Id_Estilistas` (`Id_Estilistas` ASC) VISIBLE,
  INDEX `FK3_Id_Servicios` (`Id_Servicios` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `sgcitas`.`facturas` (
  ...
  INDEX `FK1_Id_Productos` (`Id_Productos` ASC) VISIBLE,
  INDEX `FK2_Id_Servicios` (`Id_Servicios` ASC) VISIBLE,
  INDEX `FK3_Id_Clientes` (`Id_Clientes` ASC) VISIBLE,
  INDEX `FK4_Id_Estilistas` (`Id_Estilistas` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `sgcitas`.`comisiones` (
  ...
  INDEX `Fk1_Id_Facturas` (`Id_Facturas` ASC) VISIBLE,
  INDEX `Fk5_Id_Estilistas` (`Id_Estilistas` ASC) VISIBLE,
