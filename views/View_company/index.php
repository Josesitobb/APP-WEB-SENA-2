...
<body>
    ...
    <script src="modules/company/lib/easing/easing.min.js"></script>
    <script src="modules/company/lib/waypoints/waypoints.min.js"></script>
    <script src="modules/company/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="modules/company/lib/isotope/isotope.pkgd.min.js"></script>
    <script src="modules/company/lib/lightbox/js/lightbox.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="modules/company/mail/jqBootstrapValidation.min.js"></script>
    <script src="modules/company/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="modules/company/js/main.js"></script>
</body>
