...
<head>
    ...
    <style>
        ...
        .modal {
            ...
            z-index: 1;
            /* Situar el modal por encima de todo */
            left: 0;
            top: 0;
            width: 100%;
            height: 100%;
            overflow: auto;
            /* Habilitar desplazamiento si el contenido es más grande que la ventana */
